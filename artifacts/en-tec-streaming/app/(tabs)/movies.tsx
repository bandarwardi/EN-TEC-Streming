...
export default function MoviesScreen() {
  ...
  useEffect(() => {
    if (activePlaylistId && selectedCategory) {
      loadChannelsForCategory(activePlaylistId, 'vod', selectedCategory.id, selectedCategory.name);
    }
  ...
  // If a category is selected, render the movie grid
  if (selectedCategory) {
    return (
      <View style={[styles.container, { backgroundColor: colors.background, paddingTop: insets.top }]}>
        <View style={styles.header}>
          ...
          <Text style={[styles.count, { color: colors.mutedForeground }]}>
            {filteredMovies.length.toLocaleString()} titles
          </Text>
        </View>
