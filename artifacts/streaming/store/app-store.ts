    ...
    try {
      ...
      if (isXtream) {
        ...
        if (fetched) {
          ...
          console.log(`[getChannelsForCategory] Processed ${channelsList.length} channels. Storing in cache...`);
          await AsyncStorage.setItem(cacheKey, JSON.stringify(channelsList));
          return channelsList;
        } else {
